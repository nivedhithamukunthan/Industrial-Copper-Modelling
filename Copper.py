...
class prediction:
    ...
    def regression():
        ...
        if button:
            ...
            with open(r"C:\Users\mukun\Desktop\Anu's Data Science\VS\CopperModelling\classification_model.pkl", 'rb') as f:
                model = pickle.load(f)
    ...
    def classification():
        ...
        if button:
            ...
            with open(r"C:\Users\mukun\Desktop\Anu's Data Science\VS\CopperModelling\classification_model_status.pkl", 'rb') as f1:
